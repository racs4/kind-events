use std::{fmt::{Write as FmtWrite, Error}, num::ParseIntError, str::Utf8Error, time::{SystemTime, UNIX_EPOCH, Duration}, thread};
use std::str;
...
mod tests {
  ...
  fn test_hex_to_bytes() {
    ...
    assert_eq!(bytes_to_hex(&hex_to_bytes("1234567890").unwrap()), "1234567890");
  }
